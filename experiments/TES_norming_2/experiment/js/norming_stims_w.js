...
//within-subjects design: only want names of the same race (and fewer names)
var selectedNamesW = _.sample(wnames, 5)
var selectedNamesB = _.sample(bnames, 5)
var listNamesW = selectedNamesW.concat(selectedNamesW, selectedNamesW, selectedNamesW)
var listNamesB = selectedNamesB.concat(selectedNamesB, selectedNamesB, selectedNamesB)

////determines whether this is Condition_W or Condition_B
var firsts = _.shuffle(listNamesW)
...
var criticalsM = [
	{
		...
		"story":"practice",
		"storyline1":"FIRST got up with a start and realized that he should have left a while ago. He quickly got moving to go meet his friends for ",
		"storyline2":" practice.",
		"tag":"sports",
		"stimType":"critical",
		"list":1
		...
		"storyline2":" lesson before meeting up with the rest of the guys.",
		"tag":"jazz",
		"stimType":"critical",
		"list":2
	},{
