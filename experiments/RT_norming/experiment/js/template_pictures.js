...
var practice_faces_list = _.shuffle(practice_faces);

//setting up images
var b_faces_list = _.shuffle(b_faces);
var w_faces_list = _.shuffle(w_faces);
...
function make_slides(f) {
  ...
  slides.practice = slide({
    ...
    present_handle: function(stim) {
      ...
      stim.face = practice_faces_list.pop();
      var image_info = '<img src = "' + stim.face + 
      '" alt="practice_face" style="width:150px;height:150px;">';

      //Replacing the name from stimuli
      var header = "This is " + stim.first + 
        ".";
      ...
      document.getElementById('name_intro_practice').innerHTML = header;
      document.getElementById('name_picture_practice').innerHTML = image_info;
      $("name_intro_practice").show();
      $("name_picture_practice").show();
  ...
  slides.trial = slide({
    ...
    present_handle: function(stim) {
      ...
      if(stim.race == "black") {
        ...
        stim.face = b_faces_list.pop();
      } else {
        stim.first = firsts_w.pop();
        stim.face = w_faces_list.pop();
      }
      ...
      document.getElementById('name_intro').innerHTML = header;
      document.getElementById('name_picture').innerHTML = image_info;
      $("#name_intro").show();
      $("#name_picture").show();
